        ...
        <>
            ...
            <div className="bg-[#f2f2f2]">
                <div className="mt-20  pt-10  w-[80%] md:w-[60%] mx-auto   ">
                    ...
                    <p className="text-left  mb-3"><span className="underline underline-offset-1 hover:no-underline cursor-pointer hover:text-[#45b6ca]"> {unit.unit.unit_address}</span></p>
