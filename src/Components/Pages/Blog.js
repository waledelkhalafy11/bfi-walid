...
const Blog = () => {
  ...
  let after_filter = dataApi.filter(filterByNA);

  let blogData = after_filter.map((itm) => {
    return (
      <Cards
      ...
      <div className=" mt-[90px] row bg-[#f2f2f2] p-[20px]">
        ...
        <div className="col-lg-6 col-md-12 order-2 order-lg-1  my-auto p-0">
          <div className="   mt-[50px] w-[95%] md:w-[70%]  mx-auto rounded-md ">
            <h1 className="text-left text-[400%]  font-semibold leading-[86px] text-[#45b6ca]">
              Find Your
              <br />
              Dream Land
            </h1>
            ...
            <div className="">
              <p className="w-[80%] h-[220.8px] ml-[8px]  text-justify font-bold">
                {prag}
              </p>
            </div>
          </div>
