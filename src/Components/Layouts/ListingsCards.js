  ...
  return (
    <section className="ListingsCards bg-[#f2f2f2] py-[50px] ">
      <div className="container max-w-[750px] lg:max-w-[900px]">
        <h2 className="text-center  font-black">Listings available for sale</h2>
   
        <p className="mx-auto max-w-[400px] mb-5">THese are the latest properties in the Sales category displayed using the latest properties slider shortcode. You control the number of listings.</p>
        <Container>
          <OwlCarousel
